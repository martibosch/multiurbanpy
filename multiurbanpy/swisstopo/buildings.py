...
def get_bldg_gdf(
    ...
    **pooch_retrieve_kwargs,
    ...
    """Get buildings geo-data frame."""
    # we need to project the building footprints to the same CRS as the swissSURFACE3D
    # and swissALTI3D products (which is EPSG:2056)
    ...
    bldg_gdf = (
        ox.features_from_polygon(
            region_gser.to_crs(ox.settings.default_crs).iloc[0], tags=OSMNX_TAGS
        )
